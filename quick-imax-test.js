...
async function quickTest() {
  ...
  try {
    await page.goto('https://www.imax.com/ko/kr/theatre/cgv-yongsan-i-park-mall-imax');
    console.log('✅ 페이지 접속\n');
    ...
    const dateInput = await page.$eval('input[readonly]', el => el.value).catch(() => '날짜 정보 없음');
    ...
    console.log(`\n📅 예매 가능한 날짜 (${availableDays.length}개): ${availableDays.join(', ')}일`);
